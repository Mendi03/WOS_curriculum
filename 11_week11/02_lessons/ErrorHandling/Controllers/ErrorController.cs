...
public class ErrorController : Controller
{
    ...
    public IActionResult IntentionalUnauthorized(int code)

    {
        return new StatusCodeResult(401);
    }
    [HttpGet("error/not-found")]
    public IActionResult IntentionalNotFound(int code)

    {
        return new StatusCodeResult(404);
    }
    [HttpGet("error/forbidden")]
    public IActionResult IntentionalForbidden(int code)
