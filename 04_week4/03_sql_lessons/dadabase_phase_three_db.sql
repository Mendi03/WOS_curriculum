...
-- -----------------------------------------------------
-- Schema dadabase_phase_three_db
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema dadabase_phase_three_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dadabase_phase_three_db` DEFAULT CHARACTER SET utf8 ;
USE `dadabase_phase_three_db` ;

-- -----------------------------------------------------
-- Table `dadabase_phase_three_db`.`dads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dadabase_phase_three_db`.`dads` (
...
-- -----------------------------------------------------
-- Data for table `dadabase_three_db`.`dads`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `dadabase_phase_three_db`.`jokes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dadabase_phase_three_db`.`jokes` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_jokes_dads`
    FOREIGN KEY (`dad_id`)
    REFERENCES `dadabase_phase_three_db`.`dads` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Data for table `dadabase_phase_three_db`.`jokes`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `dadabase_phase_three_db`.`eyerolls`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dadabase_phase_three_db`.`eyerolls` (
  `dad_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_eyerolls_jokes1`
    FOREIGN KEY (`joke_id`)
    REFERENCES `dadabase_phase_three_db`.`jokes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Data for table `dadabase_phase_three_db`.`eyerolls`
-- -----------------------------------------------------
...
-- Jokes (IDs 1-13)
-- Jokes that WILL have eyerolls: 1, 3, 4, 5, 6, 7, 8, 13
-- Jokes that will NOT have eyerolls (for LEFT JOIN demo): 2, 9, 10, 11, 12

INSERT INTO `eyerolls` (`dad_id`, `joke_id`) VALUES
(1, 1),  -- Omar Khan eyerolls 'Why don't scientists trust atoms?'
(3, 1),  -- Maria Rodriguez also eyerolls joke 1
(4, 3),  -- Kwame Nkrumah eyerolls 'Why did the scarecrow win an award?'
(5, 4),  -- Kevin Peterson eyerolls 'How does a moon get his haircut?'
(6, 5),  -- Chen Wei eyerolls 'What do you call a boomerang that won't come back?'
(7, 6),  -- David Goldstein eyerolls 'I told my wife she was drawing her eyebrows too high.'
(8, 7),  -- Dania Hassan eyerolls 'Why don't skeletons fight each other?'
(1, 8),  -- Omar Khan eyerolls 'What do you call a lazy kangaroo?'
(7, 8),  -- David Goldstein also eyerolls joke 8
(11, 13), -- Javier Morales eyerolls 'Why did the coffee file a police report?'
(1, 6),  -- Omar Khan eyerolls 'I told my wife...'
(3, 7);  -- Maria Rodriguez eyerolls 'Why don't skeletons...'
